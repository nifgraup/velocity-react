...
var VelocityComponent = function (_React$Component) {
  ...
  _createClass(VelocityComponent, [{
    ...
    value: function componentDidUpdate(oldProps) {
      if (!(0, _lodash.isEqual)(oldProps.animation, this.props.animation)) {
    ...
    value: function runAnimation(config) {
      ...
      if (config.stop) {
        (0, _velocityAnimateShim2.default)(this._getDOMTarget(), 'stop', true);
      } else if (config.finish) {
        (0, _velocityAnimateShim2.default)(this._getDOMTarget(), 'finishAll', true);
      }

      // Delegate all props except for the ones that we have specified as our own via propTypes.
      var opts = (0, _lodash.omit)(this.props, (0, _lodash.keys)(VelocityComponent.propTypes));
      (0, _velocityAnimateShim2.default)(this._getDOMTarget(), this.props.animation, opts);
    }
    ...
    value: function _clearVelocityCache(target) {
      if (target.length) {
        (0, _lodash.forEach)(target, this._clearVelocityCache);
      } else {
        _velocityAnimateShim2.default.Utilities.removeData(target, ['velocity', 'fxqueue']);
      }
    }
...
VelocityComponent.propTypes = {
  ...
  targetQuerySelector: _propTypes2.default.string,
  interruptBehavior: _propTypes2.default.string
